  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorMessage = data.message || "Failed to create fundraiser"
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={styles.input}
                  placeholder="e.g., GWC x Woodstock's Pizza"
                  required
                />
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="e.g., Support future projects, workshops, and events!"
                />
              </div>
